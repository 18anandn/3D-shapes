...
for(int q=0;q<mypoints.get(pt1).cmnpts.size;q++) {
	...
	/*	 System.out.println("sorted");
		 for(int k=0;k<j;k++) {
			 ...
			 System.out.println(sorted[k].pt1.x);
			 System.out.println(sorted[k].pt1.y);
			 System.out.println(sorted[k].pt1.z);
			 System.out.println(sorted[k].pt2.x);
			 System.out.println(sorted[k].pt2.y);
			 System.out.println(sorted[k].pt2.z);
